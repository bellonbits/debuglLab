...
2. More examples from the React docs about when [you might not need an Effect](https://react.dev/learn/you-might-not-need-an-effect).
3. Yet another article that explains a common mistake that beginners make, [the infinite useEffect loop](https://dmitripavlutin.com/react-useeffect-infinite-loop).
